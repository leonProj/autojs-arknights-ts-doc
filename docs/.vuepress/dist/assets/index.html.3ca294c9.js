...
<span class="token punctuation">}</span>
    ...
    <span class="token comment">// ......</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="文字识别容错" tabindex="-1"><a class="header-anchor" href="#文字识别容错" aria-hidden="true">#</a> 文字识别容错</h2><p>文字识别可能会出错，比如 好友--好反 好友--好屁 好友--好龙 。对于这种情况可以设置ocrFix。参考下面明日方舟主界面的路由逻辑</p><p><code>src/router/main.ts</code></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token punctuation">[</span>
    <span class="token punctuation">{</span>
        describe<span class="token operator">:</span> <span class="token string">&#39;明日方舟主界面&#39;</span><span class="token punctuation">,</span>
        keywords<span class="token operator">:</span> <span class="token punctuation">{</span>
            <span class="token comment">// 采购中心-- 来购中己  干员寻访--下员寻访  好友--好反 好友--好屁 好友--好龙</span>
            include<span class="token operator">:</span> <span class="token punctuation">[</span><span class="token string">&#39;档案&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;采购中心&#39;</span><span class="token punctuation">,</span> <span class="token punctuation">[</span><span class="token string">&#39;公开招募&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;公开募&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span> <span class="token string">&#39;干员寻访&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;任务&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;基建&#39;</span><span class="token punctuation">,</span> <span class="token string">&#39;好友&#39;</span><span class="token punctuation">]</span><span class="token punctuation">,</span>
            ocrFix<span class="token operator">:</span> <span class="token punctuation">{</span><span class="token string-property property">&#39;来&#39;</span><span class="token operator">:</span> <span class="token string">&#39;采&#39;</span><span class="token punctuation">,</span> <span class="token string-property property">&#39;下&#39;</span><span class="token operator">:</span> <span class="token string">&#39;干&#39;</span><span class="token punctuation">,</span> <span class="token string-property property">&#39;己&#39;</span><span class="token operator">:</span> <span class="token string">&#39;心&#39;</span><span class="token punctuation">,</span> <span class="token string-property property">&#39;反&#39;</span><span class="token operator">:</span> <span class="token string">&#39;友&#39;</span><span class="token punctuation">,</span> <span class="token string-property property">&#39;屁&#39;</span><span class="token operator">:</span> <span class="token string">&#39;友&#39;</span><span class="token punctuation">,</span> <span class="token string-property property">&#39;龙&#39;</span><span class="token operator">:</span> <span class="token string">&#39;友&#39;</span><span class="token punctuation">}</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
        <span class="token function-variable function">action</span><span class="token operator">:</span> <span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token punctuation">{</span>ocrResult<span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
           <span class="token comment">// ......</span>
        <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function b(g,y){const n=c("Mimg");return o(),i("div",null,[u,r,s(n,{src:"logic/img.png"}),d,s(n,{src:"logic/img_1.png",width:"300"}),k,s(n,{src:"logic/img2.jpg",width:"300"}),v,s(n,{src:"logic/img_2.png",width:"700"}),m])}const f=p(l,[["render",b],["__file","index.html.vue"]]);export{f as default};
