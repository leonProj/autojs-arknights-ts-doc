import{_ as e,r as t,o as p,c,b as o,a as n,d as s,e as i}from"./app.cbfee2c6.js";const l={},u=n("h1",{id:"界面",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#界面","aria-hidden":"true"},"#"),s(" 界面")],-1),d=n("h2",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),r=i(`<p>上图中四个switch开关就是与这里的值绑定的，关闭代表流程没完成。开启代表流程已完成</p><p><code>src\\state\\index.ts</code></p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token doc-comment comment">/**
 * @Description: 游戏信息
 */</span>
